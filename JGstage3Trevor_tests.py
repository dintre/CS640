...
def router_tests():
  ...
  #5 1   IP packet to be forwarded to 172.16.42.2 should arrive on
    ...
    #9.7 Expect to forward original IP message out interface router-eth2
    pkt = mk_pkt(hwsrc = '10:00:00:00:00:03', hwdst =  '30:00:00:00:00:01', ipsrc  = '192.168.1.100', ipdst = '172.16.42.2', ttl=63)
    s.expect(PacketOutputEvent("router-eth2",pkt), "Expect original Packet to be forwarded out of eth-2")
